...
data_plot_symptoms_upper_respiratory_tract_symptoms <- select(import_martina, c(starts_with("slider"),symptoms_upper_respiratory_tract_symptoms, upper.age.bound, lower.age.bound)) %>%
  filter(!is.na(slider_agegp10)) %>%
  pivot_longer(starts_with("symptoms"), names_to = "symptoms", values_to = "value") 
