...
#Import the rds file
import_martina  <- readRDS("ISVARIC_dash_db_20201118_preprocess.rds")
ls(import_martina)

#Rename the agegp10 to slider_agegp10
#import_martina$slider_agegp10 <-  import_martina$agegp10
tabyl(import_martina, slider_agegp10)
tabyl(import_martina, epiweek.admit)
tabyl(import_martina, slider_monthyear)
tabyl(import_martina, slider_outcome)
...
p_resp <- ggplot(data = data_plot_vs_resp, aes(x=slider_agegp10, y=value)) + 
...
p_hr <- ggplot(data = data_plot_vs_hr, aes(x=slider_agegp10, y=value)) + 
...
p_temp <- ggplot(data = data_plot_vs_temp, aes(x=slider_agegp10, y=value)) + 
...
p_sysbp <- ggplot(data = data_plot_vs_sysbp, aes(x=slider_agegp10, y=value)) + 
...
p_oxysat <- ggplot(data = data_plot_vs_oxysat, aes(x=factor(slider_agegp10), y=value)) + 
...
##########
#Plot data_plot_lab_crp
##########

p_lab_crp <- ggplot(data = data_plot_lab_crp, aes(x=slider_agegp10, y=value)) + 
  geom_boxplot(aes(fill=slider_agegp10)) +xlab("Age groups") + ylab("CRP (mg/L)") + 
   guides(fill=guide_legend(title="Age groups"))
p_lab_crp

##########
#Plot data_plot_lab_lym
##########

p_lab_lym <- ggplot(data = data_plot_lab_lym, aes(x=slider_agegp10, y=value)) + 
  geom_boxplot(aes(fill=slider_agegp10))+xlab("Age groups") + ylab("Lymphocytes (10^9/L)") + 
  guides(fill=guide_legend(title="Age groups"))
p_lab_lym

##########
#Plot vdata_plot_lab_neut
##########

p_lab_neut <- ggplot(data = data_plot_lab_neut, aes(x=slider_agegp10, y=value)) + 
  geom_boxplot(aes(fill=slider_agegp10)) +xlab("Age groups") + ylab("Neutrophils (10^9/L)") + 
  guides(fill=guide_legend(title="Age groups"))
p_lab_neut 

##########
#Plot data_plot_lab_wbc
##########

p_lab_wbc <- ggplot(data = data_plot_lab_wbc, aes(x=slider_agegp10, y=value)) + 
  geom_boxplot(aes(fill=slider_agegp10))+xlab("Age groups") + ylab("WBC (10^9/L)") + 
  guides(fill=guide_legend(title="Age groups"))
p_lab_wbc 

##########
#Plot data_plot_lab_urean
##########

p_lab_urean <- ggplot(data = data_plot_lab_urean, aes(x=factor(slider_agegp10), y=value)) + 
...
##########
#Plot data_plot_lab_pt
##########

p_lab_pt <- ggplot(data = data_plot_lab_pt, aes(x=factor(slider_agegp10), y=value)) + 
  geom_boxplot(aes(fill=slider_agegp10))  + xlab("Age groups") + ylab("Protrombin time (s)") +
  guides(fill=guide_legend(title="Age groups"))
p_lab_pt 

##########
#Plot data_plot_lab_alt
##########

p_lab_alt <- ggplot(data = data_plot_lab_alt, aes(x=factor(slider_agegp10), y=value)) + 
...
##########
#Plot data_plot_lab_aptt
##########

p_lab_aptt <- ggplot(data = data_plot_lab_aptt, aes(x=factor(slider_agegp10), y=value)) + 
  geom_boxplot(aes(fill=slider_agegp10))  + xlab("Age groups") + ylab("APTT (s)") +
  guides(fill=guide_legend(title="Age groups"))
p_lab_aptt 

##########
#Plot data_plot_lab_bili
##########

p_lab_bili <- ggplot(data = data_plot_lab_bili, aes(x=factor(slider_agegp10), y=value)) + 
  geom_boxplot(aes(fill=slider_agegp10))  + xlab("Age groups") + ylab("Bilirubin (mmol/L)") +
  guides(fill=guide_legend(title="Age groups"))
p_lab_bili 

##########
#Plot data_plot_lab_ast
##########

p_lab_ast <- ggplot(data = data_plot_lab_ast, aes(x=factor(slider_agegp10), y=value)) + 
...
plot_comorbid_asthma <- plot.prop.by.age(data_plot_comorbid_asthma, data_plot_comorbid_asthma$value,
                         "Proportion with asthma")
plot_comorbid_asthma

#data_plot_malignant_neoplasm
plot_malignant_neoplasm <- plot.prop.by.age(data_plot_comorbid_malignant_neoplasm, data_plot_comorbid_malignant_neoplasm$value,
                                         "Proportion with malignancy")
plot_malignant_neoplasm

#data_plot_comorbid_obesity
plot_comorbid_obesity <- plot.prop.by.age(data_plot_comorbid_obesity, data_plot_comorbid_obesity$value,
                                         "Proportion with obesity")
plot_comorbid_obesity
 
#data_plot_comorbid_diabetes
plot_comorbid_diabetes <- plot.prop.by.age(data_plot_comorbid_diabetes, data_plot_comorbid_diabetes$value,
                                         "Proportion with diabetes mellitus")
plot_comorbid_diabetes

#data_plot_comorbid_dementia
plot_comorbid_dementia <- plot.prop.by.age(data_plot_comorbid_dementia, data_plot_comorbid_dementia$value,
                                         "Proportion with dementia")
plot_comorbid_dementia

#data_plot_comorbid_smoking
plot_comorbid_smoking <- plot.prop.by.age(data_plot_comorbid_smoking, data_plot_comorbid_smoking$value,
                                         "Proportion with currently smoke")
plot_comorbid_smoking

#data_plot_comorbid_hypertension
plot_comorbid_hypertension <- plot.prop.by.age(data_plot_comorbid_hypertension, data_plot_comorbid_hypertension$value,
                                         "Proportion with hypertension")
plot_comorbid_hypertension
...
data_plot_symptoms_upper_respiratory_tract_symptoms <- select(import_martina, c(starts_with("slider"),symptoms_upper_respiratory_tract_symptoms,
                                                                                symptoms_sore_throat,symptoms_runny_nose,symptoms_ear_pain,
                                                                                upper.age.bound, lower.age.bound)) %>%
  filter(!is.na(slider_agegp10)) %>%
  unite(col = "symptoms_upper_respiratory_tract_symptoms",c(symptoms_upper_respiratory_tract_symptoms,
                                                            symptoms_sore_throat,symptoms_runny_nose,symptoms_ear_pain),
        sep = "_",remove = FALSE,na.rm = FALSE) %>%
  filter(symptoms_upper_respiratory_tract_symptoms != "NA_NA_NA_NA") %>%
  mutate(symptoms_upper_respiratory_tract_symptoms = ifelse(
    symptoms_upper_respiratory_tract_symptoms %in% c(  "NA_FALSE_NA_TRUE","NA_FALSE_TRUE_FALSE", "NA_FALSE_TRUE_NA","NA_FALSE_TRUE_TRUE",    
                                                       "NA_NA_FALSE_TRUE", "NA_NA_NA_TRUE",    "NA_NA_TRUE_FALSE", "NA_NA_TRUE_NA" , "NA_NA_TRUE_TRUE",     
                                                       "NA_TRUE_FALSE_FALSE" , "NA_TRUE_FALSE_NA",  "NA_TRUE_FALSE_TRUE" ,  "NA_TRUE_NA_FALSE"  ,  
                                                       "NA_TRUE_NA_NA" , "NA_TRUE_NA_TRUE" , "NA_TRUE_TRUE_FALSE" , "NA_TRUE_TRUE_NA",   
                                                       "NA_TRUE_TRUE_TRUE" , "TRUE_NA_NA_NA"  ), TRUE, FALSE)) %>%
...
plot_symptoms_history_of_fever <- plot.prop.by.age(data_plot_symptoms_history_of_fever, data_plot_symptoms_history_of_fever$value,
                                         "Proportion with fever")
plot_symptoms_history_of_fever

#data_plot_symptoms_cough
plot_symptoms_cough <- plot.prop.by.age(data_plot_symptoms_cough, data_plot_symptoms_cough$value,
                                                   "Proportion with cough")
plot_symptoms_cough

#data_plot_symptoms_cough_fever
plot_symptoms_cough_fever <- plot.prop.by.age(data_plot_symptoms_cough_fever, data_plot_symptoms_cough_fever$value,
                                            "Proportion with fever or cough")
plot_symptoms_cough_fever

#symptoms_symptoms_shortness_of_breath
plot_data_plot_shortness_of_breath <- plot.prop.by.age(data_plot_symptoms_shortness_of_breath, data_plot_symptoms_shortness_of_breath$value,
                                              "Proportion with shortness of breath")
plot_data_plot_shortness_of_breath

#data_plot_symptoms_cought_fever_shortness_of_breath
plot_symptoms_cought_fever_shortness_of_breath <- plot.prop.by.age(data_plot_symptoms_cought_fever_shortness_of_breath, 
                                                              data_plot_symptoms_cought_fever_shortness_of_breath$value,
                                          "Proportion with cough, fever, or shortness of breath")
plot_symptoms_cought_fever_shortness_of_breath

#data_plot_symptoms_upper_respiratory_tract_symptoms
plot_symptoms_upper_respiratory_tract_symptoms <- plot.prop.by.age(data_plot_symptoms_upper_respiratory_tract_symptoms, data_plot_symptoms_upper_respiratory_tract_symptoms$value,
                                           "Proportion with upper respiratory tract symptoms")
plot_symptoms_upper_respiratory_tract_symptoms

#data_plot_symptoms_altered_consciousness_confusion
plot_symptoms_altered_consciousness_confusion <- plot.prop.by.age(data_plot_symptoms_altered_consciousness_confusion, data_plot_symptoms_altered_consciousness_confusion$value,
                                           "Proportion with confusion")
plot_symptoms_altered_consciousness_confusion

#data_plot_symptoms_constitutional
plot_symptoms_altered_consciousness_confusion <- plot.prop.by.age(data_plot_symptoms_constitutional, data_plot_symptoms_constitutional$value,
...
plot_symptoms_diarrhoea <- plot.prop.by.age(data_plot_symptoms_diarrhoea, data_plot_symptoms_diarrhoea$value,
                                               "Proportion with diarrhoea")
plot_symptoms_diarrhoea


#data_plot_symptoms_abdominal_pain
plot_symptoms_abdominal_pain <- plot.prop.by.age(data_plot_symptoms_abdominal_pain, data_plot_symptoms_abdominal_pain$value,
                                            "Proportion with abdominal pain")
plot_symptoms_abdominal_pain
...
admission.symptoms <- cbind(field = c("symptoms_runny_nose",
                     ...
                     "symptoms_history_of_fever", 
                     "symptoms_wheezing", 
                     "symptoms_cough_no_sputum",
                     "symptoms_cough_with_sputum", 
                     "symptoms_cough_bloody_sputum_haemoptysis", 
                     "symptoms_chest_pain",
